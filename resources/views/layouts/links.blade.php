...
<head>
 ...
 ============================================= -->
    ...
    <link rel="stylesheet" href="{{ asset('frontend/invoice/covid-care.css') }} " type="text/css" />
    <!-- Covid Care Custom Css -->
    <link rel="stylesheet" href="{{ asset('frontend/invoice/css/fonts.css') }}" type="text/css" />
    <!-- Covid Care Custom Fonts -->
    <!-- / -->
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/colors.php?color=0F6458') }} " type="text/css" />

    <!-- Document Title
 ============================================= -->
    <title>FinancialFlow</title>
