...
$mycolor = "#1ABC9C"; // Change your Color Here
...
.dark #gotoTop:hover,
.dark input.switch-toggle-round:checked + label::before{ background: <?php echo $mycolor; ?>; }
.dark input.switch-toggle-flat:checked + label { background: <?php echo $mycolor; ?>; }
.dark input.switch-toggle-flat:checked + label::after { background-color: <?php echo $mycolor; ?> !important; ; }
